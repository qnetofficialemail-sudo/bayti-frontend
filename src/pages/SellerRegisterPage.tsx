...
export default function SellerRegisterPage() {
  ...
  if (tokenError) return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-sm border border-error-tint p-10 w-full max-w-md text-center">
        ...
        <a href="/seller-apply" className="mt-4 inline-block text-primary-500 hover:underline text-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input type="email" required value={form.email}
              ...
              className="w-full border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary-300 bg-gray-50" readOnly />
          </div>
          <div>
