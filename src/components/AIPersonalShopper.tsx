  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-primary-500 text-white px-4 py-3 rounded-2xl shadow-xl font-medium text-sm hover:bg-primary-600 transition"
      >
            ...
            <div className="p-5">
              ...
              <div className="flex gap-2 mb-4">
                ...
                <button onClick={handleSearch} disabled={loading || !query.trim()}
                  className="bg-primary-500 text-white px-4 py-2.5 rounded-xl text-sm font-medium hover:bg-primary-600 transition disabled:opacity-50">
                  {loading ? (
                    ...
                    {recommendations.map((product: any, i: number) => (
                      <Link key={i} to={`/product/${product.id}`} onClick={() => setOpen(false)}
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-primary-500 font-semibold text-sm">AED {product.price}</div>
